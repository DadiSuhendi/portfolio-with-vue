<template>
    <div class="lg:mt-14 mt-10 w-full bg-white rounded-[30px] border border-gray-100 shadow-sm flex flex-col items-center lg:px-[80px] md:px-[60px] px-[20px] lg:py-20 py-10 text-[#222222]" id="home">
        <h1 class="font-bold lg:text-lg md:text-base text-xs uppercase border border-slate-700 px-6 py-3 rounded-full">👋 Hello, I am</h1>
        <p class="lg:text-9xl md:text-6xl text-4xl uppercase font-bold -tracking-widest lg:mt-0 mt-4">Dadi Suhendi</p>
